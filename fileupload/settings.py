...
SECRET_KEY = 'django-insecure-vvyp$wnf@l5wy%ls(6osww(!chfns^=4hck^9ls^8k#4psyhux'
...
INSTALLED_APPS = [
    ...
    'fileupload_app',  # Add the app to the installed apps
    'rest_framework',  # If using API
    'django_otp',  # For OTP functionality
    'django_otp.plugins.otp_email',  # OTP Email backend
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'file_upload_db',  # Your MySQL database name
...
LOGIN_REDIRECT_URL = '/upload/upload_file/'  # Redirect to the file upload page after login
